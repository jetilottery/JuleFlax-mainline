define(function(require) {
    ...
    return function infoPage(parts) {
        ...
        function onClickPageNoScroll(e) {
            e.stopPropagation(); //try to avoid starting a scratch on the elements below
        }
        ...
        function show() {
            ...
            scrollBarNeeded = parts.scrollBar.height < parts.bgInfo1.height;
            if(scrollBarNeeded) {
                ...
                parts.scrollBar.visible = false;
                parts.bgInfo.interactive = true; //required in order to block click-through
                parts.bgInfo.on("pointerdown", onClickPageNoScroll); //required in order to block click-through on tiles
            }
        }
